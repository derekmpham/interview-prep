...
k_one = 3
filtered_list_one = remove_k_from_list(create_nodes(list_one), k_one)
print filtered_list_one.value # prints 1

list_two = [1, 2, 3, 4, 5, 6, 7]
k_two = 10
filtered_list_two = remove_k_from_list(create_nodes(list_two), k_two)
...
k_three = 1000
filtered_list_three = remove_k_from_list(create_nodes(list_three), k_three)
